...
export default function Info() {
    return(
        <div className="App">
            <header>
                <h1>Guldsmedens Digitale Ordrebog</h1>
                <Accordion title={<span style={{ color: 'white' }}>Projektbeskrivelse</span>}>
                ...
                <Accordion title={<span style={{ color: 'white' }}>Læringsmål</span>}>
                    <div className="App-row">
                        <div className="App-column">
                            <p>Webudvikling</p>
                            <p>Viden</p>
                ...
                <Accordion title={<span style={{ color: 'white' }}>Målsætning & Kvalitetskriterier</span>}>
                    <div className="App-row">
                        <div className="App-column">
                            <p>Webudvikling</p>
                            <p>Specifikt</p>
                ...
                <Accordion title={<span style={{ color: 'white' }}>Kildemateriale</span>}>
                    <div className="App-row">
                        <div className="App-column">
                            <p>Proces</p>
                            <ul>
